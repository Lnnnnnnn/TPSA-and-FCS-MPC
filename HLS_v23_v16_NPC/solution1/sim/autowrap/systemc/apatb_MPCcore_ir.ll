; ModuleID = 'D:/MyRespostiry/HLS/PHC_v23_v16_NPC/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a6i1.312.313(i1* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, i1* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, i1* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_2, i1* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_3, i1* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_4, i1* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_5, [6 x i1]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a2struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.314.315"(i16* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, i16* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [2 x %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #1 {
entry:
...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_int<8>.498"(i8* align 512 %1, %"struct.ap_int<8>"* %0)
  ...
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.502"(i16* align 512 %5, %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"* %4)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_int<8>.498"(i8* align 512 %7, %"struct.ap_int<8>"* %6)
  call void @"onebyonecpy_hls.p0a6struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.308.309"(i16* align 512 %_0, i16* align 512 %_1, i16* align 512 %_2, i16* align 512 %_3, i16* align 512 %_4, i16* align 512 %_5, [6 x %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"]* %8)
  call void @"onebyonecpy_hls.p0a6struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.308.309"(i16* align 512 %_01, i16* align 512 %_12, i16* align 512 %_23, i16* align 512 %_34, i16* align 512 %_45, i16* align 512 %_56, [6 x %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"]* %9)
  call void @"onebyonecpy_hls.p0a3struct.ap_int<3>.310.311"(i3* align 512 %_07, i3* align 512 %_18, i3* align 512 %_29, [3 x %"struct.ap_int<3>"]* %10)
  call void @onebyonecpy_hls.p0a6i1.312.313(i1* align 512 %_010, i1* align 512 %_111, i1* align 512 %_212, i1* align 512 %_313, i1* align 512 %_414, i1* align 512 %_515, [6 x i1]* %11)
  call void @"onebyonecpy_hls.p0a2struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.314.315"(i16* align 512 %_016, i16* align 512 %_117, [2 x %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"]* %12)
  call void @"onebyonecpy_hls.p0a3struct.ap_int<3>.310.311"(i3* align 512 %_018, i3* align 512 %_119, i3* align 512 %_220, [3 x %"struct.ap_int<3>"]* %13)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a6i1.328.329([6 x i1]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", i1* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, i1* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, i1* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, i1* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3, i1* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_4, i1* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_5) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a2struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.330.331"([2 x %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", i16* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, i16* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #1 {
entry:
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<32, 12, AP_TRN, AP_WRAP, 0>.509"(%"struct.ap_fixed<32, 12, AP_TRN, AP_WRAP, 0>"* %2, i32* align 512 %3)
  ...
  call void @"onebyonecpy_hls.p0a6struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.324.325"([6 x %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"]* %8, i16* align 512 %_0, i16* align 512 %_1, i16* align 512 %_2, i16* align 512 %_3, i16* align 512 %_4, i16* align 512 %_5)
  call void @"onebyonecpy_hls.p0a6struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.324.325"([6 x %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"]* %9, i16* align 512 %_01, i16* align 512 %_12, i16* align 512 %_23, i16* align 512 %_34, i16* align 512 %_45, i16* align 512 %_56)
  call void @"onebyonecpy_hls.p0a3struct.ap_int<3>.326.327"([3 x %"struct.ap_int<3>"]* %10, i3* align 512 %_07, i3* align 512 %_18, i3* align 512 %_29)
  call void @onebyonecpy_hls.p0a6i1.328.329([6 x i1]* %11, i1* align 512 %_010, i1* align 512 %_111, i1* align 512 %_212, i1* align 512 %_313, i1* align 512 %_414, i1* align 512 %_515)
  call void @"onebyonecpy_hls.p0a2struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.330.331"([2 x %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"]* %12, i16* align 512 %_016, i16* align 512 %_117)
  call void @"onebyonecpy_hls.p0a3struct.ap_int<3>.326.327"([3 x %"struct.ap_int<3>"]* %13, i3* align 512 %_018, i3* align 512 %_119, i3* align 512 %_220)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a3struct.ap_int<3>.326.327"([3 x %"struct.ap_int<3>"]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", i3* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, i3* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, i3* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a3struct.ap_int<3>.310.311"(i3* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, i3* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, i3* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_2, [3 x %"struct.ap_int<3>"]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a6struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.308.309"(i16* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, i16* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, i16* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_2, i16* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_3, i16* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_4, i16* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_5, [6 x %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #1 {
entry:
  %1 = icmp eq i16* %_0, null
...
; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a6struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.324.325"([6 x %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", i16* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, i16* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, i16* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, i16* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3, i16* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_4, i16* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_5) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_int<8>.498"(i8* noalias align 512, %"struct.ap_int<8>"* noalias readonly) unnamed_addr #1 {
entry:
  %2 = icmp eq i8* %0, null
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>.502"(i16* noalias align 512, %"struct.ap_fixed<16, 2, AP_TRN, AP_WRAP, 0>"* noalias readonly) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<32, 12, AP_TRN, AP_WRAP, 0>.509"(%"struct.ap_fixed<32, 12, AP_TRN, AP_WRAP, 0>"* noalias, i32* noalias readonly align 512) unnamed_addr #1 {
entry:
