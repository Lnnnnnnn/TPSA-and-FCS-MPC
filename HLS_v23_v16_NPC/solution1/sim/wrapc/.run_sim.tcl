...
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2022.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2022.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2022.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2022.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "MPCcore.autotvin.dat"
	set constFileTvOut       "MPCcore.autotvout.dat"
	set constFileHdlTvIn     "MPCcore.autohdltvin.dat"
	set constFileHdlTvOut    "MPCcore.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
