...
AUTOPILOT_ROOT := E:/Vivado/Vitis_HLS/2022.1
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := E:/Vivado/Vitis_HLS/2022.1/tps/win64/msys64/mingw64/bin
endif
...
$(ObjDir)/math.cpp_pre.cpp.tb.o : math.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling math.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/ThreadFunction.cpp_pre.cpp.tb.o : ThreadFunction.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ThreadFunction.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/MPCcore.cpp_pre.cpp.tb.o : MPCcore.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling MPCcore.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
